...
<p>Pabot Lib:  pip install -U robotframework-pabot</p>
...
<h3>Using PabotLib (allows parallelism between tests cases execution)</h3>
<p>pabot --testlevelsplit --processes (CPUS) --outputdir .\results\ .\tests\test.robot<br>
❗Do NOT use more processes(workers) than your computer/container have❗</p>
